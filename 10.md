...
This is a classical recursion algorithm. The non-trivial part is how to deal with the char '*'. It turns out that we can either keep that "*" and delete the current match in String s, or delete "*" in pattern. 
